...
import { Award, ChevronRight, Eye, ShieldCheck, Trophy } from "lucide-react";
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {certificates.map((cert, index) => (
            <div
              key={cert.title}
              className={`group relative min-h-[230px] flex-col overflow-hidden rounded-[1.7rem] border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-black/30 backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:border-blue-500/50 sm:flex sm:p-6 ${
                index >= 4 && !showAll ? "hidden" : "flex"
              }`}
            >
